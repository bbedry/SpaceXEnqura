...
//MARK: Youtube Videosunu detay ekranında gösterebilmek için oluşturduğum View
struct WebViewContainer: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> WKWebView {
        guard let url = URL(string: "https://www.youtube.com/embed/\(webViewModel.youtubeId)") else {
            return WKWebView()
        }
